...
|:---:|:---:|:---:|
| <!-- ![Main Screen](screenshots/main.png) --> <br> *(Place Screenshot Here)* | <!-- ![Add Event](screenshots/add.png) --> <br> *(Place Screenshot Here)* | <!-- ![Details](screenshots/details.png) --> <br> *(Place Screenshot Here)* |
